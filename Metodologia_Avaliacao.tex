...
Dado que as tarefas 2 e 3 correspondem a funcionalidades inovadoras propostas pelo
protótipo e inexistentes na aplicação atual, adotou-se o seguinte critério de mediação
para o sistema de controlo:
\begin{itemize}
    \item \textbf{Tempo de Execução}: Foi contabilizado o tempo que cada participante demorou na procura ativa da funcionalidade até verbalizar a sua inexistência ou desistir da tarefa.
    \item \textbf{Taxa de Erros}: Foi considerada \textbf{nula} para efeitos de comparação direta, pois qualquer interação seria exploratória e não um erro de execução. 
\end{itemize}
